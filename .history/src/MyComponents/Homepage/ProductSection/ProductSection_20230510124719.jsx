      ...
      >
        <div className="rg">
          ...
          <div className="relative flex items-center homeslider">
            ...
            >
              <div
                className="gproduct-card m-2 bg-white shadow-lg p-3  border rounded-lg w-[220px] inline-block p-2 cursor-pointer  duration-300"
              ...
              >
                <img
                  ...
                  src={img8}
                  alt=""
                  className="h-30 cursor-pointer mx-auto flex flex-col items-center  object-cover overflow-hidden"
