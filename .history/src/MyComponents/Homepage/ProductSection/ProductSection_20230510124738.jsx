...
const ProductSection = () => {
  ...
  return (
    <>
      <div
        className=" mt-4 container-fluid md:m-6   p-3 md:p-6 bg-white md:mx-auto"
      ...
      >
        <div className="rg">
          ...
          <div className="relative flex items-center homeslider">
            ...
            >
              <div
                className="gproduct-card m-2 bg-white shadow-lg p-3  border rounded-lg w-[220px] inline-block p-2 cursor-pointer  duration-300 h-44"
              ...
              >
                <img
                  ...
                  src={img8}
                  alt=""
                  className="h-20 cursor-pointer mx-auto flex flex-col items-center  object-cover overflow-hidden"
