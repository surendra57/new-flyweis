      ...
      >
        <div className="rg">
          ...
          <div className="relative flex items-center homeslider">
            ...
            >
              <div
                className="gproduct-card m-2 bg-white  p-3  border rounded-lg w-[220px] inline-block p-2 cursor-pointer  duration-300 "
              ...
              >
                ...
                />
                <h2 className="text-lg font-medium mb-2">Mac Book Air MI</h2>
