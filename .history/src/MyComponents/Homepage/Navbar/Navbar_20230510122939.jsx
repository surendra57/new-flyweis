            ...
            <div>
              ...
              >
                ...
                >
                  ...
                  <button style={{color : '#333'}}>Mobile</button>
                    <br />
                  <button style={{color : '#333'}}>Laptop</button>
                  <br />
                  <button style={{color : '#333'}}>Fashion</button>
                  <br />
                  <button style={{color : '#333'}}>Electronics</button>
                  <br />
                  <button style={{color : '#333'}}>Grocery</button>
