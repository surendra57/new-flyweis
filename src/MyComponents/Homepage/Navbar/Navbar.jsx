  ...
  const Login = () => {
    ...
    const submitLogin  = async (e)=>{
      ...
      try {
        ...
        const { data } = await axios.post("https://lokender-backend-api.vercel.app/api/v1/login",
           {mobileNumber} ,
          config
        );
        ...
        <div className="logincont">
          <div className="logincont2">
            ...
            <div className="logincont2r">
              ...
              <div className="loginform">
                <div className="wrapper">
                  <div class="user-input-wrp">
                    <br />
                    <input type="text" class="inputText" required  value={mobileNumber}  onChange={(e) => setMobileNumber(e.target.value)}/>
              ...
              <button className="loginbtn" onClick={()=>submitLogin()} >Request OTP</button>
  ...
  const SignUp = () => {
    ...
    const submitSignUp  = async (e)=>{
      ...
      try {
        ...
        const { data } = await axios.post("https://lokender-backend-api.vercel.app/api/v1/register",
           {mobileNumber} ,
          config
        );
        ...
        <div className="logincont">
          <div className="logincont2">
            ...
            <div className="logincont2r">
              ...
              <button className="loginbtn" onClick={()=>submitSignUp()} >Continue</button>
